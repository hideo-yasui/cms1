	...
	<div class="col-md-12">
		<div id="main_carousel" class="carousel slide" data-ride="carousel" data-interval="5000">
			...
			<div class="carousel-inner">
				<div class="carousel-item active"> <img class="d-block" src="/img/school/carousel1.png" alt="First slide"> </div>
				<div class="carousel-item"> <img class="d-block" src="/img/school/carousel2.png" alt="Second slide"> </div>
				<div class="carousel-item"> <img class="d-block" src="/img/school/carousel3.png" alt="Third slide"> </div>
			</div>
